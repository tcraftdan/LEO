...
public class Orbit3 : MonoBehaviour
{
    ...
    public GameObject Satellite3; // the cube game obj that will orbit around
    ...
    void OrbitAround()
    {
        ...
        transform.RotateAround(Satellite3.transform.position, transform.eulerAngles, speed * Time.deltaTime); // make red cube orbit around the white cube
    }
